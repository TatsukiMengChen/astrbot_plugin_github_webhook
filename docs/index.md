...
- [安装指南](01-installation.md) - 如何安装和配置插件
- [基础配置](02-configuration.md) - 插件配置项详解
- [使用示例](03-usage.md) - 查看各种事件的消息格式示例

## 进阶使用

- [部署指南](04-deployment.md) - 防火墙、Docker 等部署相关
- [故障排查](05-troubleshooting.md) - 常见问题及解决方案

## 开发者文档

- [项目结构](07-project-structure.md) - 了解插件的代码组织
- [开发计划](06-development.md) - 贡献指南和路线图
